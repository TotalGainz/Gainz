...
//  CoreUI – Themes
//
//  Centralised Gainz colour tokens.
//  -------------------------------------------------------------
//  • SwiftUI colour extensions + semantic aliases.
//  • Dark-mode first; light mode derived algorithmically.
//  • Gradient helpers for the phoenix-wing indigo→violet fade.
//  • No external asset catalog required, yet compatible with it.
//
...
public extension LinearGradient {
    ...
    /// Default Gainz left-to-right phoenix gradient.
    ...
    /// Top-to-bottom variant for buttons / strokes.
